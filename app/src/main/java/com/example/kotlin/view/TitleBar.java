...
public class TitleBar extends ViewGroup implements View.OnClickListener {
     ...
     */
    public View addAction(View action, int index) {
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(dip2px(60), LayoutParams.WRAP_CONTENT);
        params.gravity = Gravity.CENTER;
        action.setPadding(mActionPadding, 0, mActionPadding, 0);
        mRightLayout.addView(action, index, params);
        return action;
    }
    ...
    public void setLeftImageAlpha(int alpha) {
        mLeftText.setAlpha(alpha);
    }
